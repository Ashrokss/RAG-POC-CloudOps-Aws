...
_SYSTEM_PROMPT = (
    ...
    "architecture, not a claim about history. State it directly with no "
    "[<incident id> · <section>] tag; only add one if an excerpt below actually "
    "documents a real incident where that dependency caused a failure.\n\n"
