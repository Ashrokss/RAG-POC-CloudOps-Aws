...
class RAGAnswer(BaseModel):
    ...
    # it came from the complete incident index, the okf/ dependency graph,
    # k retrieved chunks, or - known_pattern - no model call at all.
    route: Literal["retrieval", "aggregate", "blast_radius", "known_pattern"] = "retrieval"
...
class GoldenQuestion(BaseModel):
    ...
    # existing 89-question golden file loads unchanged and is still scored by
